...
for row = 1:n_row
    ...
    for col = cols
        ...
        for n = 1:size(neighbor_pattern, 1)
            ...
            if n_row_idx >= 1 && n_row_idx <= n_row ...
                    && n_col_idx >= 1 && n_col_idx <= n_col ...
                    && mask(n_row_idx, n_col_idx)
                work(n_row_idx, n_col_idx) = work(n_row_idx, n_col_idx) ...
                    + quant_error * neighbor_pattern(n, 3);
            end
        end
    end
end
