function [phase_projected, layer_map_best, best_offset] = project_phase_to_board( ...
    phase_in, phase_step, base_layers, mask, offset_seed, use_dither)
...
for idx = 1:numel(offset_candidates)
    ...
    if use_dither
        layer_map = error_diffuse_quantize_layers(layer_cont, mask, ...
            base_layers, max_layer_index);
    else
