...
function testEnabledThermalDiagnosticRequiresSpatialInput(testCase)
target = squareTarget();
params = baseParams();
params.compute_thermal_diagnostic = true;
p_amp = pressureCase(target, 2.25e6, 1.20e6);
...
verifyError(testCase, ...
    ...
    'simulate_cure_from_pressure_map:MissingThermalDiagnosticInput');
end
...
params = struct( ...
    ...
    'thermal_weight', 0.0, ...
    'compute_thermal_diagnostic', false, ...
    'penalty_weight', 0.0, ...
    'quality_risk_weight', 0.80, ...
