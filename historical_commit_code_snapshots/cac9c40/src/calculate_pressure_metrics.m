...
metrics.target_pressure_quality_score = ...
    ...
    1.2 * metrics.target_p10_over_p50 + ...
    0.5 * metrics.target_p05_over_p50 - ...
    0.35 * max(metrics.target_p95_over_mean - 1.25, 0) - ...
    0.20 * max(metrics.target_peak_over_mean - 1.60, 0) - ...
