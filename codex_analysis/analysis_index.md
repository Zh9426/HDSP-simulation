...
- `objective_curing`: covered (1.000) - Connect acoustic pressure to curing result
- `objective_future_cavitation`: planned_not_implemented (1.000) - Prepare for cavitation-aware HDSP curing model
