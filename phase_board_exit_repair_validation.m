...
fprintf('Local exit comp +kdz: repaired scan PCC %.4f at %.2f mm | phase best=%s | coh %.4f | RMS %.4f rad\n', ...
    local_exit_diagnostic.metrics.comp_plus.repaired_best_pcc, ...
    local_exit_diagnostic.metrics.comp_plus.repaired_best_z_mm, ...
...
fprintf('Local exit comp -kdz: repaired scan PCC %.4f at %.2f mm | phase best=%s | coh %.4f | RMS %.4f rad\n', ...
    ...
    local_exit_diagnostic.metrics.comp_minus.repaired_best_z_mm, ...
