...
metrics.target_pressure_p25_pa = prctile(target_values, 25);
metrics.target_pressure_p50_pa = prctile(target_values, 50);
metrics.target_pressure_p75_pa = prctile(target_values, 75);
...
metrics.target_p25_over_p50 = metrics.target_pressure_p25_pa / (metrics.target_pressure_p50_pa + eps);
metrics.target_p75_over_p50 = metrics.target_pressure_p75_pa / (metrics.target_pressure_p50_pa + eps);
...
metrics.target_p75_over_p25 = metrics.target_pressure_p75_pa / (metrics.target_pressure_p25_pa + eps);
metrics.target_p90_over_p10 = metrics.target_pressure_p90_pa / (metrics.target_pressure_p10_pa + eps);
metrics.target_p95_over_p05 = metrics.target_pressure_p95_pa / (metrics.target_pressure_p05_pa + eps);
metrics.target_band_10_fraction = mean(abs(target_values / (metrics.target_pressure_p50_pa + eps) - 1) <= 0.10);
metrics.target_band_15_fraction = mean(abs(target_values / (metrics.target_pressure_p50_pa + eps) - 1) <= 0.15);
metrics.target_band_20_fraction = mean(abs(target_values / (metrics.target_pressure_p50_pa + eps) - 1) <= 0.20);
metrics.target_below_70_p50_fraction = mean(target_values < 0.70 * metrics.target_pressure_p50_pa);
metrics.target_above_130_p50_fraction = mean(target_values > 1.30 * metrics.target_pressure_p50_pa);
...
metrics.dark_above_target_p10_fraction = mean(dark_values >= metrics.target_pressure_p10_pa);
metrics.dark_above_target_p50_fraction = mean(dark_values >= metrics.target_pressure_p50_pa);
metrics.dark_mean_over_target_mean = metrics.mean_dark_pressure_pa / (metrics.mean_target_pressure_pa + eps);
metrics.global_peak_in_target = peak_target_idx == peak_linear_idx;
